                ...
                <div className="container">
                    <div className="relative max-w-md mx-auto">
                        <input
                            ...
                            className="w-full px-3 py-2 pl-10 bg-gray-700/50 border border-gray-600 rounded-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm"
                        />
                    ...
                    {(globalSearchTerm || '').trim() === '' && (
                        <>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mb-4">
                                <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-sm p-3 shadow-xl">
                                ...
                                <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-sm p-3 shadow-xl">
                                    <div className="flex items-center justify-between">
                                        <div>
                                ...
                                <div className="bg-gradient-to-r from-green-500 to-green-700 rounded-sm p-3 shadow-xl">
                                    <div className="flex items-center justify-between">
                                        <div>
                                ...
                                <div className="bg-gradient-to-r from-purple-500 to-purple-700 rounded-sm p-3 shadow-xl">
                                    <div className="flex items-center justify-between">
                                        <div>
                                ...
                                <div className="bg-gradient-to-r from-indigo-500 to-indigo-700 rounded-sm p-3 shadow-xl">
                                    <div className="flex items-center justify-between">
                                        <div>
                                ...
                                <div className="bg-gradient-to-r from-cyan-500 to-cyan-700 rounded-sm p-3 shadow-xl">
                                    <div className="flex items-center justify-between">
                                        <div>
